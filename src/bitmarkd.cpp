...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to Refugecoind / RPC client
            std::string strUsage = _("Refugecoin Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  Refugecoind [options]                     " + _("Start Refugecoin Core Daemon") + "\n" +
                _("Usage (deprecated, use Refugecoin-cli):") + "\n" +
                  "  Refugecoind [options] <command> [params]  " + _("Send command to Refugecoin Core") + "\n" +
                  "  Refugecoind [options] help                " + _("List commands") + "\n" +
                  "  Refugecoind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        if (fDaemon)
        {
            fprintf(stdout, "Refugecoin server starting\n");
...
int main(int argc, char* argv[])
{
    ...
    // Connect Refugecoind signal handlers
    noui_connect();
