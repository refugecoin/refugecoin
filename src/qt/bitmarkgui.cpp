    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Refugecoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitmarkGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Refugecoin address"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitmark"), tr("&About Refugecoin Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitmark_testnet"), tr("&About Refugecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Refugecoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Refugecoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Refugecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Refugecoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Refugecoin Core help message to get a list with possible Bitmark command-line options"));
...
void BitmarkGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Refugecoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Refugecoin client") + " " + tr("[testnet]"));
...
void BitmarkGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Refugecoin network", "", count));
}

void BitmarkGUI::setNumBlocks(int count, int nTotalBlocks)
{
...
{
    QString strTitle = tr("Refugecoin"); // default title
