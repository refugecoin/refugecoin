...
QString BitmarkUnits::name(int unit)
{
    ...
    case mRGC: return QString("uRGC");
    case uRGC: return QString::fromUtf8("uRGC");
...
QString BitmarkUnits::description(int unit)
{
    switch(unit)
    {
    case RGC: return QString("Refugecoins");
    case mRGC: return QString("mRefugecoins (1 / 1,000)");
    case uRGC: return QString("uRefugecoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
...
qint64 BitmarkUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case RGC:  return Q_INT64_C(21000000);
    case mRGC: return Q_INT64_C(21000000000);
    case uRGC: return Q_INT64_C(21000000000000);
    default:   return 0;
    }
}
