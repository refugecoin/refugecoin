...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Western New York buried by snow";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        vSeeds.push_back(CDNSSeedData("http://www.messengercoin.org/", "seed1.http://www.messengercoin.org/", "seed2.http://www.messengercoin.org/"));

        base58Prefixes[PUBKEY_ADDRESS] = list_of(60); // b
        base58Prefixes[SCRIPT_ADDRESS] = list_of(35);
        base58Prefixes[SECRET_KEY] =     list_of(5); // B
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("Refugecoin.co", "test.Refugecoin.co"));

        base58Prefixes[PUBKEY_ADDRESS] = list_of(97); // u
        base58Prefixes[SCRIPT_ADDRESS] = list_of(110);
        base58Prefixes[SECRET_KEY]     = list_of(117); // U
