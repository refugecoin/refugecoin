...
BITMARKD=${1}/Refugecoind
CLI=${1}/Refugecoin-cli
...
# "Miner":
D4=${D}/node4
CreateDataDir $D4 port=11030 10823=11031
B4ARGS="-datadir=$D4"
...
# "Spenders" 1/2/3
D1=${D}/node1
CreateConfDir $D1 port=11000 10823=11001 addnode=127.0.0.1:11030
B1ARGS="-datadir=$D1"
$BITMARKD $B1ARGS &
B1PID=$!
D2=${D}/node2
CreateConfDir $D2 port=11010 10823=11011 addnode=127.0.0.1:11030
B2ARGS="-datadir=$D2"
$BITMARKD $B2ARGS &
B2PID=$!
D3=${D}/node3
CreateConfDir $D3 port=11020 10823=11021 addnode=127.0.0.1:11030 addnode=127.0.0.1:11000
B3ARGS="-datadir=$D3"
