...
D1=${D}/node1
CreateDataDir "$D1" port=11000 10823=11001
B1ARGS="-datadir=$D1"
$BITMARKD $B1ARGS &
B1PID=$!

D2=${D}/node2
CreateDataDir "$D2" port=11010 10823=11011 connect=127.0.0.1:11000
B2ARGS="-datadir=$D2"
$BITMARKD $B2ARGS &
B2PID=$!

D3=${D}/node3
CreateDataDir "$D3" port=11020 10823=11021 connect=127.0.0.1:11000
B3ARGS="-datadir=$D3"
