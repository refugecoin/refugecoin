...
This will build Refugecoin-qt as well if the dependencies are met.
...
If you want to build Refugecoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a Refugecoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip Refugecoind" to strip the debug
