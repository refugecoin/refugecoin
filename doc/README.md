...
You need the Qt4 run-time libraries to run Refugecoin-Qt. On Debian or Ubuntu:

	sudo apt-get install libqtgui4

Unpack the files into a directory and run:

- bin/32/Refugecoin-qt (GUI, 32-bit) or bin/32/Refugecoind (headless, 32-bit)
- bin/64/Refugecoin-qt (GUI, 64-bit) or bin/64/Refugecoind (headless, 64-bit)



### Windows

Unpack the files into a directory, and then run Refugecoin-qt.exe.

### OSX

Drag Refugecoin-Qt to your applications folder, and then run Refugecoin-Qt.
