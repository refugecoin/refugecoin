...
In order to support loading of multiple wallets in Refugecoin-qt, a few changes in the UI architecture will be needed.
...
Finally, two new headers and source files will have to be added to Refugecoin-qt.pro.
...
----------------------
bitmark.cpp is the entry point into Refugecoin-qt, and as such, will require some minor modifications to provide hooks for
